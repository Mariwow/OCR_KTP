                        ...
                        <div class="card border-top-0">
                            <div class="card-header">
                                <h5 class="fw-bold mb-0">
                                    <span class="d-block mb-2">Rejected Data</span>
                                    <span class="fs-12 fw-normal text-muted">Data yang ditolak dapat dipulihkan</span>
                                </h5>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="hstack gap-2 justify-content-end">
                                                        ...
                                                        <button type="button" onclick="prepareRestore({{ $data->id }}, '{{ $data->type }}')" class="btn btn-sm btn-icon btn-outline-success" title="Pulihkan">
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm"> 
            <div class="modal-content">
                <div class="modal-body p-4 text-center">
                    <i class="fa-solid fa-trash-can-arrow-up text-success mb-3" style="font-size: 3rem;"></i>
                    <h5 class="fw-bold">Pulihkan Data?</h5>
                    <p class="text-muted small mb-4">
                        Data ini akan dipulihkan, anda yakin?
                    </p>
                    
                    <form id="formRestore" method="POST">
                        @csrf
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-success">Ya, Pulihkan Data</button>
