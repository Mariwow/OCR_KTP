                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="res_kode_negara" name="kode_negara" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Passport Number</label>
                                <input type="text" class="form-control" id="res_no_paspor" name="no_paspor" required>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control" id="res_kewarganegaraan_paspor" name="kewarganegaraan" required>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="jenis_kelamin" id="res_jenis_kelamin_male" value="Male" required>
                                        <label class="form-check-label" for="res_jenis_kelamin_male">Male</label>
                                    </div>
                                    
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="jenis_kelamin" id="res_jenis_kelamin_female" value="Female" required>
