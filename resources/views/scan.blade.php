                                ...
                                <div class="row">
                                    <div class="col-xxl-4 col-lg-4 col-md-4">
                                        <div class="card stretch stretch-full border border-dashed border-gray-5">
                                            <div class="card-body rounded-3 text-center">
                                                <div class="ratio-2-3">
                                                    <img src="{{ asset('assets/images/ktp.png') }}" alt="Gambar KTP" class="img-fluid rounded" style="width: 100%; height: 600px; object-fit: cover;">
                                                </div>
                                    ...
                                    <div class="col-xxl-4 col-lg-4 col-md-4">
                                        <div class="card stretch stretch-full border border-dashed border-gray-5">
                                            <div class="card-body rounded-3 text-center">
                                                <div class="ratio-2-3">
                                                    <img src="{{ asset('assets/images/Passport.webp') }}" alt="Gambar Passport" class="img-fluid rounded" style="width: 100%; height: 600px; object-fit: cover;">
                                                </div>
                                                <div class="fs-4 fw-bolder text-dark mt-3 mb-1">
